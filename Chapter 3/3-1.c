...
int main(void) {
    ...
    printf("binsearch() took %1u clocks (%1u seconds)\n",
    ...
    printf("binsearch2() took %1u clocks (%1u seconds)\n",
           (unsigned long) time_taken,
           (unsigned long) time_taken / CLOCKS_PER_SEC);
    system("pause");
    return 0;
...
binsearch() took 71 clocks (0 seconds)   
Element 10 found at index 10.   
binsearch2() took 9 clocks (0 seconds)

实验结果表明，将更多的测试在循环外执行会减少运行时间
*/